            ...
            <div class="col-8">
                ...
                <form method="post" action="/gudang/{{ $gudang->id }}">
                    ...
                    @csrf
                        ...
                        <input type="text" class="form-control @error('no_invoice') is-invalid @enderror" id="no_invoice" placeholder="Masukan No Invoice" name="no_invoice" value="{{ $gudang->no_invoice }}">
                            @error('no_invoice')
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('nama_brang') is-invalid @enderror" id="nama_brang" placeholder="Masukan Nama Barang" name="nama_brang" value="{{ $gudang->nama_brang }}">
                            @error('nama_brang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('alamat_barang') is-invalid @enderror" id="alamat_barang" placeholder="Masukan Alamat Barang" name="alamat_barang" value="{{ $gudang->alamat_barang }}">
                            @error('alamat_barang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                          ...
                          <textarea class="form-control @error('deskripsi_barang') is-invalid @enderror" id="deskripsi_barang" placeholder="Masukan Deskripsi Barang" name="deskripsi_barang" value="{{ $gudang->deskripsi_barang }}" rows="3"></textarea>
